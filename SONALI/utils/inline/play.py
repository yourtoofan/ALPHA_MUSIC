...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
      ...
      [
            InlineKeyboardButton(
                text="𝖮ᴡɴᴇʀ 🥀", url="https://t.me/MR_ABHI_OP_1",
            ),
            InlineKeyboardButton(
                text="𝖲ᴜᴘᴘᴏʀᴛ 🥀", url="https://t.me/music_x_bot_ll",
            )
        ],
...
def stream_markup(_, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="𝖮𝗐𝗇𝖾𝗋🥀", url="https://t.me/MR_ABHI_OP_1",
            ),
            InlineKeyboardButton(
                text="𝖲𝗎𝗉𝗉𝗈𝗋𝗍🥀", url="https://t.me/music_x_bot_ll",
            )
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
